  ...
  static final List<Map<String, dynamic>> menuItems = [
    {
      ...
      'price': 15000,
      'category': 'Makanan',
      'icon': 'assets/images/ayam_geprek.png',
      'sold_today': 42,
      'predicted': 48,
    },
    {
      ...
      'price': 18000,
      'category': 'Makanan',
      'icon': 'assets/images/sambal_matah.png',
      'sold_today': 28,
      'predicted': 32,
    },
    {
      ...
      'price': 5000,
      'category': 'Makanan',
      'icon': 'assets/images/nasi_putih.png',
      'sold_today': 65,
      'predicted': 72,
    },
    {
    ...
    },
    {
      ...
      'price': 7000,
      'category': 'Minuman',
      'icon': 'assets/images/es_jeruk.png',
      'sold_today': 30,
      'predicted': 35,
    },
    {
      ...
      'price': 22000,
      'category': 'Makanan',
      'icon': 'assets/images/ayam_mozarella.png',
      'sold_today': 15,
      'predicted': 18,
    },
    {
      ...
      'price': 3000,
      'category': 'Tambahan',
      'icon': 'assets/images/tahu_crispy.png',
      'sold_today': 40,
      'predicted': 45,
    },
    {
      ...
      'price': 3000,
      'category': 'Tambahan',
      'icon': 'assets/images/tempe_goreng.png',
      'sold_today': 35,
      'predicted': 38,
    },
  ];
  ...
  static final List<Map<String, dynamic>> recentTransactions = [
    {
      'id': 'TRX-001',
      'time': '11:42',
      'items': ['Ayam Geprek Original', 'Nasi Putih', 'Es Teh'],
      'total': 25000,
      'qty': 3,
    },
    {
      'id': 'TRX-002',
      'time': '11:38',
      'items': ['Ayam Geprek Mozarella', 'Nasi Putih', 'Es Jeruk'],
      'total': 34000,
      'qty': 3,
    },
    {
      'id': 'TRX-003',
      'time': '11:35',
      'items': ['2x Ayam Geprek Original', '2x Nasi Putih', '2x Es Teh'],
      'total': 50000,
      'qty': 6,
    },
    {
      'id': 'TRX-004',
      'time': '11:30',
      'items': ['Ayam Geprek Sambal Matah', 'Nasi Putih', 'Tahu Crispy'],
      'total': 26000,
      'qty': 3,
    },
    {
      'id': 'TRX-005',
      'time': '11:25',
      'items': ['3x Ayam Geprek Original', '3x Nasi Putih'],
      'total': 60000,
      'qty': 6,
    },
  ];
